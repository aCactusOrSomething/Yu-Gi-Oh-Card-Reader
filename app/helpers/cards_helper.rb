...
module CardsHelper
  ...
  def applyKeyWords(words, visitedKeywords: [])
    ...
    def transform(word, _keyword)
      word
    end
    applyTransformations(words, KEYWORDS, method(:transform), transformFirst: method(:transformFirst),
                                                              visited: visitedKeywords).append(@keyWordList)
  end
  ...
  def applyAbbreviations(words, visitedAbbreviations: [])
    ...
    applyTransformations(words, ABBREVIATIONS, method(:transform), transformFirst: method(:transformFirst),
                                                                   visited: visitedAbbreviations)
  end
